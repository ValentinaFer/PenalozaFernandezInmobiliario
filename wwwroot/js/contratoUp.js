$(document).ready(function () {
    ...
    console.log("contrato up:", IdContratoEditando);
    console.log("contrato Inmuebe:", idInmuebleEditando);
 ...
 //debe haber seleccionado inquilino e inmueble para pasar al step 3
    ...
    function handleShowReview() {
        ...
        if (IdContratoEditando >0) {
            $.ajax({
                url: `/Contrato/Inmueble/GetOccupiedMonths/${inmuebleId}`,
                type: "GET",
            })
